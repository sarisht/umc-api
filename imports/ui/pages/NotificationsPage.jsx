...
class NotificationsPage extends Component {
    ...
    //     return (
    //         <a key={notification.claim_id} href={"/claims/" + notification.claim_id} className="collection-item avatar">
    //             Vote for this Claim
    //         </a>
    //     );
    // }
    ...
    renderEmpty() {
        return (
            <li className="collection-item text-secondary">No Notifications</li>
        );
    }
    renderLoggedIn(){
    ...
    renderLoggedOut() {
        return (
            <div className="section">
                <h4>Please log in to check the notifications. </h4>
